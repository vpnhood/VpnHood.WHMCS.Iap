...
How to connect **your** Google Play app to the `vpnhoodiap` addon so
subscriptions bought inside your branded Android app become orders in your
WHMCS. Part of the [White-Label Guide](https://github.com/vpnhood/VpnHood.WHMCS.Partner/blob/main/docs/WHITE-LABEL.md); the general concepts
